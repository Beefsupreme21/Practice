...
class CollectionController extends Controller
{
    ...
    public function index()
    {
        ...
        $collectionAll = collect($collection)->all(); 
        $collectionAverage = collect($collection)->avg(); 
        $collectionChunk = collect($collection)->chunk(2); 

        return view('welcome', [
            'collectionAll' => $collectionAll,
            'collectionAverage' => $collectionAverage,
